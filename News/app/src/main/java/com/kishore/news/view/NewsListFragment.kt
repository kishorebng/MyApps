...
//        }
        ...
        val shared= mySharedPreferencesKoinDagger.getStringPreference(mContext.getString(com.kishore.news.R.string.country_entry_key),"")
        if(TextUtils.isEmpty(shared)) {
            mySharedPreferencesKoinDagger.putStringPreference(mContext.getString(com.kishore.news.R.string.country_key),NewsUtil.getCountryCode())
            mySharedPreferencesKoinDagger.putStringPreference(mContext.getString(com.kishore.news.R.string.country_entry_key),NewsUtil.getDisplayCountry())
        }
