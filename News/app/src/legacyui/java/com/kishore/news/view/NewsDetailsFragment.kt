...
class NewsDetailsFragment : Fragment() {
    ...
    @Inject
    lateinit var newsDetailsViewModelFactory: NewsDetailsViewModel.NewsDetailsViewModelFactory
...
//        mNewsListViewModel = InjectorUtils.provideNewsDetailsModel(requireActivity().applicationContext, args.newsId)
        mNewsListViewModel = newsDetailsViewModelFactory.create(args.newsId)
